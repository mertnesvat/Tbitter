...

{
...

  {
    ...
    //echo '<br><br>selam -----'.$url.'----<br>';

    $url = 'http://api.twitter.com/friendships/create.json'; // ekleme islemi icin api gonderir.

    //$url = 'http://api.twitter.com/1/friendships/destroy.json'; //silme islemi icin api gonderir.
...
/// BENIM DANDIK VE COK FARKLI OLMAYAN SILMEK ICIN TASARLANMIS MAL CLASS'IM PIPITWITTER
class pipiTwitter extends EpiOAuth
